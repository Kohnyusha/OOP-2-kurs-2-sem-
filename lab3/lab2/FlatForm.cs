...
namespace lab2
{
    public partial class FlatForm : Form
    {
        ...
        private void buttonOutputInfo_Click(object sender, EventArgs e)//вывести инфу о кв
        {
            ...
            foreach (var flat in flatsCollection)
            {
                ...
                if (flat.LivingRoom)
                    outputLine.AppendLine(" - Гостинная");
        ...
        private void buttonAutoFill_Click(object sender, EventArgs e)
        {
            ...
            dateTimePickerYear.Value = DateTime.Parse("2022-03-18");
        ...
        private void toolStripMenuItemSave_Click(object sender, EventArgs e)//о программе
        {
            MessageBox.Show($"Версия : 1.0\nРазработала: Кохнюк Александра");
            toolStripStatusLabelAction.Text = "Просмотрена информация о программе";
        }

        private void toolStripMenuItemSearchYear_Click(object sender, EventArgs e)//поиск по году
        {
        ...
        private void toolStripMenuItemSearchDistrict_Click(object sender, EventArgs e)//поиск по району
        {
        ...
        private void toolStripMenuItemSearchAmountRooms_Click(object sender, EventArgs e)//поиск по комнатам
        {
        ...
        public void printSortedInfo(Flat item)//вывод сортировки
        {
            countSortedFlats++;
            StringBuilder outputLine = new StringBuilder();
            ...
            outputLine.AppendLine("Адрес:" + item.address.Country + "\n" + "р-н. " + item.address.District + ", ул. " + item.address.Street + "\n д." +
        ...
        private void toolStripMenuItemSortFootage_Click(object sender, EventArgs e)//сорт по метражу
        {
            sortType = 1;
            if (flats.Count < 1)
        ...
        private void toolStripMenuItemSortYear_Click(object sender, EventArgs e)//сорт по году
        {
            sortType = 0;
            if (flats.Count < 1)
                MessageBox.Show($"Вы не сохранили ни одну квартиру!");
        ...
        private void toolStripMenuItemSortPrice_Click(object sender, EventArgs e)//сорт по цене
        {
            sortType = 2;
            if (flats.Count < 1)
                MessageBox.Show($"Вы не сохранили ни одну квартиру!");
        ...
        private void buttonSearchSave_Click(object sender, EventArgs e)//сохр поиск
        {
            ...
            {
                MessageBox.Show($"Данные успешно записаны в файл \"search_result.xml\"");
            }
        }

        private void buttonSortSave_Click(object sender, EventArgs e)//сохр сортировку
        {
            List<Flat> list = new List<Flat>();
            try
            {
            ...
            {
                MessageBox.Show($"Данные успешно записаны в файл \"sort_result.xml\"");
            }
        }

        private void ToolStripMenuItemSortResult_Click(object sender, EventArgs e)//сохр рез сорт
        {
            buttonSortSave_Click(this, e);
        }

        private void ToolStripMenuItemSearchResult_Click(object sender, EventArgs e)//сохр резз поиска
        {
            buttonSearchSave_Click(this, e);
        }

        //нижнее меню
        private void toolStripMenuItemYearSear_Click(object sender, EventArgs e)//поиск по году
        {
            toolStripMenuItemSearchYear_Click(this, e);
        }

        private void toolStripMenuItemDistrictSear_Click(object sender, EventArgs e)//поиск по району
        {
            toolStripMenuItemSearchDistrict_Click(this, e);
        }

        private void toolStripMenuItemRoomsSear_Click(object sender, EventArgs e)//поиск по кол-у комнат
        {
            toolStripMenuItemSearchAmountRooms_Click(this, e);
        }

        private void toolStripMenuItemYear_Click(object sender, EventArgs e)//сорт по году
        {
            toolStripMenuItemSortYear_Click(this, e);
        }

        private void toolStripMenuItemFootage_Click(object sender, EventArgs e)//сорт по метражу
        {
            toolStripMenuItemSortFootage_Click(this, e);
        }

        private void toolStripMenuItemRooms_Click(object sender, EventArgs e)//сорт по цене
        {
            toolStripMenuItemSortPrice_Click(this, e);
        }

        private void toolStripMenuItemSortRes_Click(object sender, EventArgs e)//сохр сорт
        {
            ToolStripMenuItemSortResult_Click(this, e);
        }

        private void toolStripMenuItemSearchRes_Click(object sender, EventArgs e)//сохр поиск
        {
            ToolStripMenuItemSearchResult_Click(this, e);
        }

        private void toolStripButtonAbout_Click(object sender, EventArgs e)//инфа о проге
        {
            toolStripMenuItemSave_Click(this, e);
        }

        private void toolStripButtonClearInfo_Click(object sender, EventArgs e)//очистка
        {
            buttonClearInfo_Click(this, e);
        }

        private void ToolStripMenuItemHideTool_Click(object sender, EventArgs e)//скрыть панель
        {
