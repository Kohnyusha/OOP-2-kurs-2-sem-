...
namespace lab2
{
    public partial class FlatForm : Form
    {
        ...
        private void buttonOutputInfo_Click(object sender, EventArgs e)//вывод инфы о кв
        {
            try
            {
        ...
        private void buttonClearInfo_Click(object sender, EventArgs e)//оичстить
        {
        ...
        private void buttonGetCost_Click(object sender, EventArgs e)//вывод стоимости
        {
            double footage;
            int amountOfRooms;
            int year;
        ...
        private void textBoxDistrict_KeyPress(object sender, KeyPressEventArgs e)//район
        {
        ...
        private void textBoxStreet_KeyPress(object sender, KeyPressEventArgs e)//ул
        {
            string Symbol = e.KeyChar.ToString();
            if (!Regex.Match(Symbol, @"[а-яА-Я]|[a-zA-Z]").Success && e.KeyChar != 8 && e.KeyChar != 32)
            {
        ...
        private void textBoxNumberHouse_KeyPress(object sender, KeyPressEventArgs e)//номер дома
        {
            string Symbol = e.KeyChar.ToString();
        ...
        private void textBoxNumberFlat_KeyPress(object sender, KeyPressEventArgs e)//номер кв
        {
            string Symbol = e.KeyChar.ToString();
            if (!Regex.Match(Symbol, @"[0-9]").Success && e.KeyChar != 8)
            {
        ...
        private void buttonSave_Click(object sender, EventArgs e)//сохранить кв
        {
            double footage;
            int amountOfRooms;
            int year;
        ...
        private void buttonAddRoom_Click(object sender, EventArgs e)//добавить инфу о комнате
        {
            RoomForm roomForm = new RoomForm();
            roomForm.Show();
        }

        private void buttonOutputRoomInfo_Click(object sender, EventArgs e)//вывести инфу о комнате
        {
            try
            {
